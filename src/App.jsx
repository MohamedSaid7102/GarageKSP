  ...
  return (
    <>
      ...
      <div className="to-top-btns">
        ...
        {/* To Top Icons Button */}
        <a
          href={`tel:{data.phones}`}
          className="progress-bar-item circle"
          style={{
            fontSize: "2.5rem",
            width: "50px",
            height: "50px",
        ...
        >
          <FontAwesomeIcon
            icon={faPhone}
            style={{ fontWeight: "lighter", fontSize: "1.3rem" }}
      ...
      >
        ...
        {sections.map((section, index) => (
          <div
            className={`snap-section  ${isWideScreen && "center-content"}`}
            id={`section-${index + 2}`}
          >
            {section}
          </div>
