...
const ProductItem = ({
  ...
  return (
    <div
      className="project-item card-item-transition-effect m-1 m-sm-3 border"
      style={{ ...style }}
    >
      ...
      <div className="p-4">
        <a
          className="d-block h5 text-sm-start"
          href="#"
          style={{
            textDecoration: "none",
            fontSize: "25px",
        ...
        {quantity && (
          <span
            className="d-block text-sm-start mb-3"
            style={{ fontSize: "20px", fontWeight: "lighter" }}
          >
            <span style={{ fontSize: "25px", fontWeight: "normal" }}>
              Quantity:{" "}
            </span>
            {quantity}
          </span>
...
const ProductWrapper = ({
  ...
  useEffect(() => {
    if (selectedProject !== null) {
      instance
        .get(`/mobile/client/products/${selectedProject}`)
        .then((response) => {
  ...
  return (
    <>
      <div
        className="projects-wrapper d-flex flex-row flex-wrap justify-content-md-start justify-content-center"
        style={{ height: "550px" }}
      >
      ...
      <Modal show={showModal} onHide={closeModal} size="lg">
        ...
        <Modal.Body style={{ height: "80vh" }}>
          {selectedProjectData && (
            <>
              <img
                src={selectedProjectData.images[0].url}
              ...
              >
                ...
                {selectedProjectData.selling_price}
              </span>
      ...
      <div className="container">
        ...
        >
          ...
          <h1 className="display-5 mb-5">
            We've Done Lot's of Awesome Products
          </h1>
          ...
          <button
            className={`btn btn-outline-info btn-sm rounded border-0 mb-3 fw-light`}
