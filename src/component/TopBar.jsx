      ...
      <div className="container py-3">
        <div className="d-flex align-items-center">
          ...
          <div className="ms-auto d-flex align-items-center">
            <small className="ms-4"><i className="fa fa-map-marker-alt me-3" aria-hidden="true"></i>123 Street, New York, USA</small>
            <small className="ms-4"><i className="fa fa-envelope me-3" aria-hidden="true"></i>info@example.com</small>
            <small className="ms-4"><i className="fa fa-phone-alt me-3" aria-hidden="true"></i>+012 345 67890</small>
