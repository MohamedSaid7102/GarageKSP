...
export const NavigationBar = () => {
  ...
  const navLinkStatus = (path) => {
    ...
    return darkMode
      ? "nav-item nav-link text-white font-weight-bold"
  ...
  return (
    <div
      className={`sticky-top navigation-bar ${darkMode && "bg-secondary"}`}
      ...
      <div className={`container-fluid sticky-top`}>
        <div className={`container p-0`}>
          <nav className={`navbar navbar-expand-lg navbar-light p-lg-0`}>
            ...
            <Link
              to={"/"}
              className={`navbar-brand d-lg-none text-decoration-none`}
            >
            ...
            >
              <h2
                className={`${darkMode ? "text-white" : "text-dark"} m-0`}
